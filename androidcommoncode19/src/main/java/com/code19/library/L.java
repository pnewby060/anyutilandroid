...
//初始化log tag和是否输出log
    ...
    public static void crash2File(Context context, Throwable throwable) {
        ...
        builder.append("\nappVersionName:" + AppUtils.getAppVersionName(context,context.getApplicationInfo().packageName));
        builder.append("\nappVersionCode:" + AppUtils.getAppVersionCode(context,context.getApplicationInfo().packageName));
