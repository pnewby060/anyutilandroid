...
public class MapUtil {
    ...
    /**
     * 增加key非空的键值对到map中，value为空时使用默认值
     ...
     * @param ignoreSpace whether ignore space at the begining or end of key and value
     * @return
     */
